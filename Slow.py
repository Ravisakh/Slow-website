...
# Clear the terminal
os.system("clear")
os.system("figlet Slow")

print()
print(colored("Create By  : Za KDOR THOM ", 'green'))
print(colored("FB : Za Koj Koj", 'magenta'))
print(colored("Github   : https://github.com/Ravisakh", 'red'))
print(colored("about slow : Slow as Ddos Website Makes Website Slow .", 'cyan'))
print(colored("BHEH Is not responsible for misusing it and must have an NDA signed to perform such attacks", 'red'))
print(colored("You are using Slow Version: 1.0", 'yellow'))
print()
